...
class processes{
    function sendemail_verify($message)
    {
        ...
        try {
            ...
            $mail->addAddress('tevot191030@gmail.com', 'Joe mama');     //Add a recipient
            $mail->addAddress('tevot191030@gmail.com');   //to receive            //Name is optional
